...
func TestMedicationCreate(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			inputBody: `{"name": "valid", "dosage": "valid", "form": "Capsule"}`,
			wantBody:  mockedWantBody,
		},
		{
			name:      "Invalid name",
			...
			inputBody: `{"name": ["invalid"], "dosage": "valid", "form": "Capsule"}`,
		...
		},
		{
			...
			urlPath:   "/v1/medications",
			wantCode:  http.StatusBadRequest,
			inputBody: `{"name": "valid", "dosage": true, "form": "Capsule"}`,
		...
		},
		{
			...
			inputBody: `{"dosage": "valid", "form": "Capsule"}`,
		...
		},
		{
			...
			urlPath:   "/v1/medications",
			wantCode:  http.StatusUnprocessableEntity,
			inputBody: `{"name": "valid", "form": "Capsule"}`,
		...
		},
		{
			...
			urlPath:   "/v1/medications",
			wantCode:  http.StatusUnprocessableEntity,
			inputBody: `{"name": "valid", "dosage": "Capsule"}`,
		...
		{
			name:      "Wrong values for form validation",
			urlPath:   "/v1/medications",
			wantCode:  http.StatusUnprocessableEntity,
			inputBody: `{"name": "foo", "dosage":"foo", "form": "Wrong"}`,
			wantBody:  "Form expects one of the following values: Tablet, Capsule, Liquid",
		},
	}
...
func TestMedicationPatch(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			urlPath:   "/v1/medications/1",
			wantCode:  http.StatusOK,
			inputBody: `{"name": "name-foo", "dosage": "dosage-foo", "form": "Liquid"}`,
			wantBody:  `{"ID":1,"Name":"name-foo","Dosage":"dosage-foo","Form":"Liquid`,
		},
		{
			...
			wantBody:  `{"ID":1,"Name":"name-bar","Dosage":"dosage-foo","Form":"Liquid`,
		},
		{
			...
			wantBody:  `{"ID":1,"Name":"name-bar","Dosage":"dosage-bar","Form":"Liquid`,
		},
		{
			name:      "Valid PATCH form",
			urlPath:   "/v1/medications/1",
			wantCode:  http.StatusOK,
			inputBody: `{"form": "Liquid"}`,
			wantBody:  `{"ID":1,"Name":"name-bar","Dosage":"dosage-bar","Form":"Liquid`,
		},
		{
